export const INITIAL_BLOG_DATA = {
  currentlyPlaying: {
  ...
  reviews: [
    {
      ...
      rating: "4.9/5",
      summary:
        "A heartfelt, laugh-out-loud comedy that turns a simple sports premise into a powerful study of human kindness and mental health.",
      imageUrl:
    ...
    },
    {
      ...
      rating: "4.8/5",
      summary:
        "A spectacular return to Midgar, masterfully blending tactical real-time combat with deep emotional storytelling.",
      imageUrl:
    ...
    },
    {
      ...
      rating: "4.7/5",
      summary:
        "A joyous, lightning-fast action-platformer that showcases the power of modern SSD technology with seamless rift-hopping.",
      imageUrl:
        "https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/1895880/library_600x900.jpg",
      category: "game",
      paragraphs: [
  ...
  upcomingGames: [
    {
      ...
      synopsis:
        "Head back to Leonida, the home of neon-soaked streets and wild highways of Vice City, in Rockstar's next boundary-pushing open-world epic.",
      imageUrl:
        "https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/271590/header.jpg", // high contrast fallback
    ...
    },
    {
      ...
      synopsis:
        "Samus Aran embark on a brand-new space-faring operation. Expect intense visor-scanning exploration, deep lore, and tight plasma-beam shooting.",
      imageUrl:
        "https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/1046930/header.jpg",
  ...
  upcomingShows: [
    {
      ...
      synopsis:
        "The severed employees of Lumon Industries continue their search for the truth of their surgical division after the mind-bending season 1 cliffhanger.",
      imageUrl:
        "https://image.tmdb.org/t/p/w500/7sYv0MdfwcoK6yKkX2gAn0M9nU3.jpg",
    ...
    },
    {
      ...
      synopsis:
        "The epic final season. Eleven, Mike, Dustin, Lucas, Will, and Max face the ultimate inter-dimensional invasion as the Upside Down bleeds fully into Hawkins.",
      imageUrl:
        "https://image.tmdb.org/t/p/w500/49W6qd6jW6Y66mYvSOfv6Yp8bX1.jpg",
  ...
  upcomingMovies: [
    {
      ...
      synopsis:
        "Denis Villeneuve concludes Paul Atreides' destiny. Twelve years into his holy war, Paul grapples with his emperorship and the dark fate of Arrakis.",
      imageUrl:
        "https://image.tmdb.org/t/p/w500/czemb67gpf6Yg9W0g7gcyS486bA.jpg",
